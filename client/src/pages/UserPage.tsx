      ...
      <div className="flex flex-col md:flex-row mx-10 bg-gradient-to-br p-6 rounded-lg shadow-lg">
        ...
        <div className="lg:w-1/4 p-6 sticky top-6 rounded-lg text-center">
          ...
          <img
            ...
            alt="Profile"
            draggable="false"
            className="rounded-full  object-cover pointer-events-none cursor-pointer select-none mx-auto 
       mb-4 w-48 h-48 shadow-[0px_123px_123px_123px_rgba(79,0,128,0.3)]"
          ...
          <p className="mt-4 opacity-80 text-sm">
            I'm an experienced C++ programmer with a passion for low-level
            coding and performance optimization. My focus is on building
            efficient, reliable solutions and writing clean, well-structured
            code. I believe in the importance of quality and security in every
            line I write, ensuring my code is both robust and optimized.
          </p>
              ...
              <h1 className="font-inter text-white">
                ...
                <div className="flex mt-2">
                  <img
                    ...
                    className="select-none"
                    height="24"
                    src="https://img.icons8.com/fluency-systems-filled/48/FFFFFF/link.png"
                    alt="link"
                  />
                  <div
                    style={{
                  ...
                  >
                    https://www.youtube.com/watch?v=VUlkvVNuNeA
                  </div>
                </div>
                <div className="flex mt-2">
                  <img
            ...
            <div className="md:w-3/2">
              <div className="flex items-center mb-4">
                ...
                <div className="flex-grow bg-gradient-to-r from-purple-950 to-transparent h-1 rounded-full relative">
                  <p className="text-lg opacity-55 mt-3 select-none absolute top-[-1.5rem] right-0"></p>
                </div>
              </div>
              <p className="text-white text-base">
                Hello, I'm Destruct – an 18-year-old C++ developer based in
                Moscow, Russia. I specialize in low-level programming,
                performance optimization, and system design. With a deep passion
                for understanding how software interacts with hardware, I focus
                on writing clean, efficient, and reliable code. Over the past
                year, I’ve built various utilities, including game macros,
                process managers, and tools for enhancing system-level
                performance. My projects showcase a strong understanding of
                algorithms, data structures, and multithreading. I’m not just
                passionate about coding—I’m dedicated to solving complex
                challenges with simplicity and precision. Whether it’s
                developing backend architectures, experimenting with TypeScript
                for web development, or integrating robust database solutions, I
                aim to deliver high-quality results that stand the test of time.
                When I’m not coding, I enjoy diving into anime, playing Genshin
                Impact, and staying updated on the latest innovations in
                technology and design. If you're interested in discussing tech,
                games, or collaborative projects, feel free to reach out.
              </p>
            </div>
            {/*----------------------------------------------------------- */}
          </div>
