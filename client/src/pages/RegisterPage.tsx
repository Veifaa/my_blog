    ...
    <div className="flex min-h-screen font-inter text-white">
      <div className="hidden lg:flex items-center justify-center w-1/2 bg-cover bg-center relative">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <span className="text-5xl font-bold font-inter text-center">
            Welcome to Ve
            <span className='"text-lg font-bold bg-gradient-to-r font-inter from-blue-500 to-purple-600 text-transparent bg-clip-text'>
              Q
            </span>
            tra
          </span>
      ...
      <div className="flex flex-col items-center justify-center w-full lg:w-1/2 p-8">
        <div className="bg-[#1b1b1b00] rounded-lg shadow-lg p-8 max-w-md w-full">
          <h2 className="text-3xl font-semibold font-inter text-center mb-10">
            Sign Up to VeQtra
          </h2>
